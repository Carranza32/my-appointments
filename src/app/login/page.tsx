  ...
  return (
    <div className="relative min-h-screen w-screen overflow-hidden flex flex-col justify-center items-center px-6 py-20 font-sans">
      ...
      <main className="relative z-10 w-full max-w-[420px] bg-frost-glass border border-white/20 p-8 rounded-3xl dark:bg-slate-900/45 dark:border-white/5 shadow-frost backdrop-blur-xl animate-in fade-in zoom-in-95 duration-300">
        ...
        {/* Development Onboarding Demos Links */}
        <div className="mt-6 pt-4 border-t border-slate-200/50 dark:border-slate-800/40 text-center select-none">
          <span className="text-[8px] font-black uppercase tracking-widest text-slate-450 dark:text-slate-500 block">
            Dev Tools
          </span>
          <div className="mt-2 flex items-center justify-center gap-3 text-[9px] font-bold text-[#1A73E8]/80 dark:text-blue-450/80">
            <Link href="/onboarding" className="hover:underline">Original Onboarding</Link>
            <span className="text-slate-300 dark:text-slate-800">|</span>
            <Link href="/onboarding-test" className="hover:underline">Wizard Onboarding (Test)</Link>
          </div>
        </div>
      </main>
